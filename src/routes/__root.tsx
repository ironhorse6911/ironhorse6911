  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        <h1 className="text-7xl font-bold text-primary text-glow-cyan">404</h1>
        <h2 className="mt-4 text-xl font-semibold">Signal lost</h2>
        <p className="mt-2 text-sm text-muted-foreground">
          This node is offline or was never part of the grid.
        </p>
        <div className="mt-6">
          <Link
            to="/"
            className="inline-flex items-center justify-center rounded-md bg-primary px-4 py-2 text-sm font-medium text-primary-foreground shadow-neon-cyan transition-colors hover:opacity-90"
          >
            Return to fortress
          </Link>
        </div>
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "SENTINEL/9 — Autonomous AI Cyber Fortress" },
      {
        name: "description",
        content:
      ...
      { name: "author", content: "SENTINEL/9" },
      { property: "og:title", content: "SENTINEL/9 — Autonomous AI Cyber Fortress" },
      {
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Orbitron:wght@500;700;900&family=JetBrains+Mono:wght@300;400;500;700&display=swap",
      },
      {
        rel: "stylesheet",
        href: appCss,
